...
router
  /**
   * @api {get} /v1/invoices list active invoices
   * @apiVersion 1.0.0
   * @apiPermission user
  ...
  /**
   * @api {get} /v1/invoices/archived list archived invoices
   * @apiVersion 1.0.0
   * @apiPermission user
  ...
  //----- EDIT
  /**
   * @api {get} /v1/invoices/:id get an invoice
   * @apiVersion 1.0.0
   * @apiPermission user
   * @apiName GetInvoice
   * @apiGroup Invoices
  ...
  /**
   * @api {post} /v1/invoices/:id update an invoice
   * @apiVersion 1.0.0
   * @apiPermission user
  ...
  /**
   * @api {post} /v1/invoices/:id/archive archive an invoice
   * @apiVersion 1.0.0
   * @apiPermission user
