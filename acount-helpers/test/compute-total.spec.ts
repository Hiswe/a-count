...
test(`${productTotalTitle} – regular use case`, t => {
  t.is(
    productTotal({ description: ``, checked: true, quantity: 0, price }),
    0,
    `quantity: 0`,
  )
  t.is(
    productTotal({ description: ``, checked: true, quantity: 0.5, price }),
    175,
    `quantity: 0.5`,
  )
  t.is(
    productTotal({ description: ``, checked: true, quantity: 1, price }),
    350,
    `quantity: 1`,
  )
  t.is(
    productTotal({ description: ``, checked: true, quantity: 1.3333, price }),
    466.75,
    `quantity: 1.3333`,
  )
})
...
test(`${productTotalTitle} – string input`, t => {
  ...
  t.is(
    // @ts-ignore
    productTotal({ checked: true, quantity: 1, price: `350` }),
    price,
    `stringed price`,
  )
  t.is(
  ...
  t.is(
    // @ts-ignore
    productTotal({ checked: true, quantity: `foo`, price }),
    0,
    `invalid string number`,
  )
  t.is(
    // @ts-ignore
    productTotal({ checked: true, quantity: 1, price: `foo` }),
    0,
    `invalid string price`,
  )
  t.is(
    // @ts-ignore
    productTotal({ checked: true, quantity: true, price: `foo` }),
    0,
    `both invalid`,
  )
})
...
test(`${totalsTitle} – regular use case`, t => {
  const products = [
    { checked: true, quantity: 0.5, price },
