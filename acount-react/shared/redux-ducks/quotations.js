...
export const LIST_GET_READY_INVOICE = createActionNames(
  NAME,
  `get`,
  `list-ready-to-invoice`
)
export const LIST_FOR_CUSTOMER = createActionNames(
  NAME,
  `get`,
  `list-for-customer`
)
...
export default function reducer(state = initialState, action) {
  ...
  switch (type) {
    ...
    case CREATE_INVOICE.SUCCESS: {
      ...
      const updated =
        index < 0 ? state : state.set(`readyToInvoice[${index}]`, payload)
